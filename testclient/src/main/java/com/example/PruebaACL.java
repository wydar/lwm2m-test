...
public class PruebaACL extends BaseInstanceEnabler {

    private static final Logger LOG = LoggerFactory.getLogger(PruebaACL.class);
    ...
    public PruebaACL(Float latitude, Float longitude, float scaleFactor) {
        if (latitude != null) {
